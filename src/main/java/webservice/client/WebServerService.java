 ...
 * 
 */
@WebServiceClient(name = "WebServerService", targetNamespace = "http://webservice.java.main/", wsdlLocation = "http://localhost:8887/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVERSERVICE_QNAME = new QName("http://webservice.java.main/", "WebServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8887/HelloWorld?wsdl");
    ...
    public WebServer getWebServerPort() {
        return super.getPort(new QName("http://webservice.java.main/", "WebServerPort"), WebServer.class);
    }
    ...
    public WebServer getWebServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.java.main/", "WebServerPort"), WebServer.class, features);
    }
