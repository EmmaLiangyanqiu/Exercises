...
public class ObjectFactory {
    ...
    private final static QName _GetStringResponse_QNAME = new QName("http://webservice.java.main/", "getStringResponse");
    private final static QName _GetString_QNAME = new QName("http://webservice.java.main/", "getString");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.java.main/", name = "getStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.java.main/", name = "getString")
